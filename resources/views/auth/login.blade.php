...
<script type="module" src="https://cdn.jsdelivr.net/npm/web-particles@1.1.0/dist/web-particles.min.js"></script>
                ...
                <div class="card-body d-flex justify-content-center p-4">
                    ...
                    <form class="form p-5" method="POST" action="{{ route('login') }}">
                    <div class="d-flex justify-content-center">
                    <h2>{{ __('Login') }}</h2>
</div>
                        @csrf

                        <div class="coloumn d-flex flex-wrap flex-column align-content-center mb-3 mt-3">
                        ...
                        <div class=" mb-0 d-flex justify-content-center mb-3">
                            <div class="col-md-6 col-12 mt-3">
